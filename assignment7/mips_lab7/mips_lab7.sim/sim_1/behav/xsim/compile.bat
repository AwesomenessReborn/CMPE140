...
REM
REM Generated by Vivado on Sun Nov 02 14:57:15 -0800 2025
...
echo "xvlog --incr --relax -prj mips_fpga_vlog.prj"
call xvlog  --incr --relax -prj mips_fpga_vlog.prj -log xvlog.log
